...
<html lang="en" class="no-js">
  <?php $pagetitle = 'EPL Manager | Consortium'; ?>
  ...
  <!-- End Head -->
    ...
    <body>
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-fullheight--xs event-landing1" id="swades" style="background: url('img/1920x1080/renderico-landing.png');">
            <div class="container g-ver-center--sm g-padding-y-125--xs g-padding-y-0--lg event-landing-inner">
                ...
                <div class="g-margin-t-30--xs g-margin-t-0--sm g-margin-b-30--xs g-margin-b-70--md g-margin-l-20--xs g-margin-l-80--sm">
                    ...
                    <h1 class="g-font-size-50--xs g-font-size-80--sm g-font-size-80--lg g-color--white" style="font-weight:900; text-shadow: 2px 0 #333;letter-spacing:2px;"><b>Render.ico</b></h1>
            ...
            <div class="card" id="event-card-bg">
                ...
                <br>
    			     	...
    			     	<ol>
    			     	    ...
    			     	    <li><p>Great opportunity to show your designing skills.</p></li>
