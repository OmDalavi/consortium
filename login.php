            ...
            <div class="row g-hor-centered-row--md g-margin-t-20--sm">
                <div class="col-lg-4 col-sm-4 g-hor-centered-row__col">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <form submit="" action="login.php <?php if($_GET['v'] == 'ai/ml'){echo '?v=ai/ml';}?>" method="post" class="center-block g-width-300--xs g-width-350--md g-bg-color--white-opacity-lightest g-box-shadow__dark-lightest-v3 g-padding-x-40--xs g-padding-y-40--xs g-radius--4">
