...
$("#operation_researchclick").click(function(){
  ...
  $("#paylinkoperation_research").animate({opacity: 1}, 1000);
  var y = $("#operation_research").offset().top;
    $("html ,body").animate({ scrollTop: y},200);
});

$("#details_clickoperation_research").click(function(){
  $("#detailsoperation_research").css({"display":"block"});
  $("#detailsoperation_research").animate({opacity: 1}, 1000);
  var y = $("#operation_research").offset().top;
    $("html ,body").animate({ scrollTop: y},200);
});

$("#adteam_clickoperation_research").click(function(){
  $("#membersoperation_research").css({"display":"block"});
  $("#membersoperation_research").animate({opacity: 1}, 1000);
  var y = $("#operation_research").offset().top;
    $("html ,body").animate({ scrollTop: y},200);
});
