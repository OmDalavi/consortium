...
<html lang="en" class="no-js">
  <?php $pagetitle = 'Operation Research| Consortium'; ?>
        ...
        <div class="s-promo-block-v3 g-fullheight--xs event-landing1" style="background: url('img/1920x1080/swades-landing-page.jpg');" id="swades">
            <div class="container g-ver-center--sm g-padding-y-125--xs g-padding-y-0--lg event-landing-inner">
                ...
                <div class="g-margin-t-20--xs g-margin-t-0--sm g-margin-b-20--xs g-margin-b-50--md g-margin-l-20--xs g-margin-l-60--sm">
                    ...
                    <h1 class="g-font-size-60--xs g-font-size-80--sm g-font-size-80--lg g-color--white" style="font-weight:900; text-shadow: 2px 0 #333;letter-spacing:2px;"><b>Operation Research</b></h1>
                    <h1 class="g-font-size-20--xs g-font-size-30--sm g-font-size-30--lg g-color--white" style="font-weight:900; text-shadow: 2px 0 #333;letter-spacing:2px;"><b>Optimise and Rise</b></h1>
